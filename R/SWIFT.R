...
#'                               siganture profile with depth [in permil, VSMOW]
#'                  Structure:   A discrete vector of n elements, with n the 
...
#'        
#'        
#'  # Field data coroborating the hypothesis of strong isotopic fluctuations 
...
#===============================================================================
      ...
      hts <-  length( as.vector(hom) )   # when looping over multiple heights
...
#' 
#' Research Location:
#' Soil samples were collected at the Hainich National Park
#' close to the vilage of Weberstedt in Central Germany.
#' Height of sampling was approx. 350 m a.s.l. and the region
#' experiences a subatlatic climate with a mean anual precimitation
#' around 600 mm and st.dev. around 50mm
#' More details are provided in both articles of Meissner et al, 2012
#' 
#' 
#' Dataset abstract: 
#' These data is being used to test the hypothesized mechanisms of
#' xylem water isotopic variation along the length of a plant.
#'     
#' Methods:
